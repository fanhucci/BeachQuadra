...
//import { EditarContaSchema, CriarContaDTO, CriarContaSchema, ListarContaDTO } from "@app/shared";
import { useEffect, useState } from "react"
import { toast } from "sonner";

export default function ContasPage(){
    // const estadoInicial:CriarContaDTO = {
    //     id_conta:null,
    //     conta:"",
    //     senha:"",
    //     cargo:0
    ...
    //         const tabela = data.map((conta: ListarContaDTO) => ({
    //             conta: conta.conta,
    ...
    // function abrirEdicao(conta:ListarContaDTO){
    ...
    //         : CriarContaSchema.safeParse(formData);
