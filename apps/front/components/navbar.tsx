...
import { LogOut, User, Calendar, Users, DollarSign, Layers, Clock, Menu, CalendarDays, ChevronLeft, X, BookOpen, CalendarPlus2 } from "lucide-react";
      ...
      <div className="flex items-center gap-4">
        {isAuthenticated ? (
          <div className="relative flex items-center gap-3" ref={menuRef}>
            ...
            <SubmitButton
              estilo="fantasma"
              className="p-2! bg-transparent! hover:bg-gray-800 rounded-full"
...
export function EmployeeSidebar() {
  ...
  const links = [
    { href: "/usuarios/agendar", label: "Novo Agendamento", icon: CalendarPlus2 },
